...
public class ESClientSpringFactory {
    ...
    public static int CONNECT_TIMEOUT_MILLIS = 1000;           //获取连接超时
    public static int SOCKET_TIMEOUT_MILLIS = 30000;          //读超时
    public static int CONNECTION_REQUEST_TIMEOUT_MILLIS = 500;    //请求超时
    public static int MAX_CONN_PER_ROUTE = 10;          //单个主机的最大连接数
    public static int MAX_CONN_TOTAL = 30;              //连接池的最大连接数
